...
public class ConfigManager {
    ...
    public static void loadConfig(final FileConfiguration config){
        ...
        ALREADY_IN_SECTOR = translateAlternateColorCodes('&', config.getString("already-in-sector"));
        ...
        NOT_A_PLAYER_OR_SECTOR = translateAlternateColorCodes('&', config.getString("not-a-player-or-sector"));
    ...
    public static String NOT_A_PLAYER_OR_SECTOR;
    ...
    public static String ALREADY_IN_SECTOR;
